...
if selected_menu == "Upload & Extract":
    ...
    if uploaded_card is not None:
        ...
        def save_card(uploaded_card):
            with open(os.path.join(r"C:\Users\prajw\Downloads\drive-download-20230806T145347Z-001",
        ...
        extracted_text = reader.readtext(
            os.path.join(r"C:\Users\prajw\Downloads\drive-download-20230806T145347Z-001", uploaded_card.name),
            detail=0)
        content = []
